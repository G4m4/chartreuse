/// @file audioharmonicity.h
/// @brief AudioHarmonicity descriptor declaration
/// @author gm
/// @copyright gm 2014
///
...
#ifndef CHARTREUSE_SRC_DESCRIPTORS_AUDIOHARMONICITY_H_
#define CHARTREUSE_SRC_DESCRIPTORS_AUDIOHARMONICITY_H_
...
class AudioHarmonicity : public Descriptor_Interface {
 ...
 private:
  ...
  AudioHarmonicity& operator=(const AudioHarmonicity& right);
};

}  // namespace descriptors
}  // namespace chartreuse

#endif  // CHARTREUSE_SRC_DESCRIPTORS_AUDIOHARMONICITY_H_
