#!/usr/bin/env python
'''
@file audio_spectrum_centroid.py
@brief Sandbox for "audio spectrum centroid" algorithm tests
@author gm
@copyright gm 2014
...
class AudioSpectrumCentroid(object):
    '''
...
#             sin_data[idx + pulse_width / 2:idx + pulse_width] = -1
    ...
    descriptor = AudioSpectrumCentroid(sampling_freq,
                                       dft_length,
                                       frame_length,
                                       overlap)
